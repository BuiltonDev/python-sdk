...
class Subscription(Components):
    ...
    def start(self, body, url_params=None, json=False):
        return self.simple_query(_type='post', _id=self.id, resource='start', url_params=url_params, body=body,
                                 json=json)

    def stop(self, body, url_params=None, json=False):
        return self.simple_query(_type='post', _id=self.id, resource='stop', url_params=url_params, body=body,
                                 json=json)
