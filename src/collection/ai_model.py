...
class AIModel(Components):
    ...
    def train(self, url_params=None, json=False):
        return self.simple_query(_type='post', _id=self.id, resource='train', url_params=url_params, json=json)
    ...
    def create(self, body, url_params=None, json=False):
        return self.simple_query(_type='post', _id=self.id, body=body, url_params=url_params, json=json)
