...
class Order(_Component):
    ...
    def get_deliveries(self, url_params=None):
        return self._simple_query(_id=self.id, resource='deliveries', url_params=url_params,
                                  json=True)
    ...
    def create_delivery(self, body, url_params=None):
        return self._simple_query(_type='post', _id=self.id, resource='deliveries', body=body,
                                  url_params=url_params,
                                  json=True)
