...
class Tag(_Component):
    ...
    def get_products(self, url_params=None, json=False):
        return self._simple_query(resource='products', url_params=url_params, json=json,
                                  res_constructor=Product)

    def get_providers(self, url_params=None, json=False):
        return self._simple_query(resource='providers', url_params=url_params, json=json,
